                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-[#666666] text-lg max-w-2xl mb-8">
                                    Achieve a deep, mirror-like gloss with the SkyGloss Shine System, designed for maximum clarity and aesthetic depth.
                                </p>
                        ...
                        <div className="space-y-16">
                            ...
                            <div id="conditions" className="scroll-mt-32">
                                ...
                                <div className="mt-8 flex justify-end">
                                    <Button
                                        ...
                                        className={`rounded-xl px-8 h-12 font-bold text-xs uppercase tracking-widest transition-all ${completedSteps.includes('conditions') ? 'bg-[#0EA0DC] text-emerald-700 border border-emerald-200' : 'bg-[#272727] text-[#64748b]'}`}
                                    >
                            ...
                            <div id="step1-apply" className="scroll-mt-32 space-y-12">
                                <div className="text-center space-y-4 mb-8">
                                    ...
                                    <h2 className="text-4xl font-bold text-[#272727] tracking-tighter uppercase italic">SHINE COAT Deployment</h2>
                                </div>
                                ...
                                <Card className="skygloss-card p-8 sm:p-12 rounded-[32px] border-l-4 border-l-[#0EA0DC]">
                                    <div className="flex flex-col  gap-8">
                                        ...
                                        <div className="flex-1 space-y-6">
                                            ...
                                            <div className="flex justify-end">
                                                <Button onClick={() => markComplete('step1-apply')} className={`rounded-xl px-10 h-14 font-bold transition-all ${completedSteps.includes('step1-apply') ? 'bg-[#0EA0DC] hover:bg-[#0c80b3] shadow-lg shadow-[#0EA0DC]/20' : 'bg-[#0EA0DC] hover:bg-[#0c80b3] shadow-lg shadow-[#0EA0DC]/20'}`}>
                                                    {completedSteps.includes('step1-apply') ? 'SHINE Verified' : 'Confirm Deployment'}
                                                </Button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="step2-cure" className="scroll-mt-32 mt-8 mb-8">
                                <Card className="p-8 sm:p-14 rounded-lg border-gray-100 bg-white relative overflow-hidden shadow-sm">
                                    ...
                                    <div className="flex justify-end pt-4">
                                        <Button
                                            ...
                                            className="bg-[#0EA0DC] text-white hover:bg-amber-600 shadow-lg rounded-xl px-10 h-14 font-bold"
                                        >
                            ...
                            <div id="protection" className="scroll-mt-32">
                                <Card className="p-8 sm:p-14 rounded-lg border-none bg-[#272727] text-white relative overflow-hidden shadow-2xl">
                                    ...
                                    <div className="relative z-10 flex flex-col gap-12 items-center">
                                        <div className="md:w-[45%] text-center md:text-left space-y-6">
                                            ...
                                            <p className="text-white/40 font-medium leading-relaxed italic text-sm">
                                                Maintaining the mirror-like luster requires consistent care and standard pH neutral maintenance.
                                            </p>
                                        </div>
