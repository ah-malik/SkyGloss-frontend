...
export function Footer() {
  const socialLinks = [
    { name: "Instagram", url: "https://www.instagram.com/skygloss.services" },
    { name: "Facebook", url: "https://www.facebook.com/skygloss.services" },
    // { name: "X", url: "#" },
    // { name: "TikTok", url: "#" },
  ...
  const supportLinks = [
    { name: "FAQs", url: "https://skygloss.com/faq/" },
    { name: "Warranty", url: "https://skygloss.com/warranty/" },
    { name: "Contact Us", url: "https://skygloss.com/contact-us/" },
  ];

  const companyLinks = [
    { name: "About", url: "https://skygloss.com/about-us/" },
    ...
    <footer style={{ marginTop: "20px" }} className="bg-[#0EA0DC]  text-white rounded-t-[32px] sm:rounded-t-[48px]">
      ...
      <div className="w-full pb-8 -mt-4">
        ...
        <div className="flex items-center justify-end gap-4 text-sm text-white/80 px-6 sm:px-8 lg:px-12">
          <a href="https://skygloss.com/" className="hover:text-white transition-colors duration-200">
            SkyGloss, Inc. All Rights Reserved 2026
          </a>
          <span>|</span>
          <a href="https://skygloss.com/privacy-policy/" className="hover:text-white transition-colors duration-200">
            Privacy Policy
          </a>
        </div>
      </div>
