...
import { ShoppingBag, GraduationCap, Search, Eye, ShoppingCart, Plus, Minus } from "lucide-react";
...
const products = [
  {
    ...
    image: fusionElementImage,
    description: "Advanced fusion coating technology",
    price: 79.99
  },
  {
    id: 2,
    name: "FUSION AETHER",
    sizes: ["100ml", "250ml"],
    image: fusionAetherImage,
    description: "Premium aether protection coating",
    price: 99.99
  },
  {
    id: 3,
    ...
    description: "Professional resin & film coating protection",
    price: 160.99
  },
  {
    id: 4,
    ...
    sizes: ["250ml"],
    image: sealImage,
    description: "Advanced sealing protection spray",
    price: 89.99
  },
  {
    id: 5,
    ...
    sizes: ["30ml"],
    image: matteBoxImage,
    description: "Premium matte finish coating",
    price: 129.99
  },
  {
    id: 6,
    ...
    sizes: ["30ml"],
    image: shineBoxImage,
    description: "Professional shine enhancer coating",
    price: 99.99
  },
  {
    id: 7,
    ...
    description: "Professional application bottle for precise coating application",
    price: 9.99
  },
  {
    id: 8,
    ...
    description: "Tungsten carbide blade for professional clear coating application",
    price: 49.99
  },
  {
    id: 10,
    ...
    description: "Rock chip and scratch repair pen for professional paint touch-ups",
    price: 29.99
  }
];
        ...
        >
          <div className="inline-flex rounded-xl border-2 border-[#0EA0DC] p-1 bg-white shadow-[0_0_10px_rgba(14,160,220,0.1)]">
            <button
              ...
              className={`flex items-center px-10 py-4 rounded-lg transition-all duration-200 ${
                activeTab === "shop"
                    ...
                    >
                      <Card className="skygloss-card p-5 rounded-2xl h-full flex flex-col">
                        ...
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <Badge className="bg-green-100 text-green-800 border-0 px-2.5 py-0.5 text-xs">
                            In Stock
                          </Badge>
                        </div>
                          ...
                          <div className="grid grid-cols-1 gap-2">
                            {product.sizes.map(size => (
                              <button
                                ...
                                className={`px-3 py-3 rounded-lg text-xs sm:text-sm transition-all duration-200 text-center leading-tight ${
                ...
                >
                  <Card className="skygloss-card p-6 rounded-2xl h-full flex flex-col">
                    ...
                    <p className="text-sm text-[#666666] mb-4 flex-1">
                      Complete training course with 10 comprehensive lessons covering application techniques, safety procedures, and best practices.
                    </p>
