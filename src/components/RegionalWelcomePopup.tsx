        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md">
                <motion.div
                    ...
                    className="w-full max-w-lg bg-white rounded-[2rem] overflow-hidden shadow-2xl border border-[#0EA0DC]/10"
                >
                    {/* Header with Background Pattern */}
                    <div className="relative h-32 bg-gradient-to-br from-[#0EA0DC] to-[#0b89bc] flex items-center justify-center overflow-hidden">
                    ...
                    <div className="p-8 sm:p-10 text-center">
                        <h2 className="text-2xl sm:text-3xl font-bold text-[#272727] mb-3">
                            Welcome to the SkyGloss Portal
                        </h2>
                        <p className="text-[#0EA0DC] font-semibold mb-6">We’re excited to have you here.</p>
