...
export function ShopRegistration() {
        ...
        const isStepValid = useMemo(() => {
            if (step === 1) {
                ...
                const isCouponValid = couponCode === 'CERTIFICATIONBONUS';
        ...
        const handleSubmit = async (e: React.FormEvent) => {
            ...
            try {
                ...
                } else if (response.data?.user && formData.couponCode === 'CERTIFICATIONBONUS') {
        ...
        const registrationFee = useMemo(() => {
                ...
                const isFree = formData.couponCode === 'CERTIFICATIONBONUS';
                            ...
                            <Card className="skygloss-card p-8 rounded-2xl bg-white border-2 border-[#0EA0DC]/10 shadow-[0_8px_30px_rgba(14,160,220,0.1)]">
                                ...
                                <form onSubmit={(e) => {
                                    ...
                                    if (step === 1) {
                                        ...
                                        if (formData.couponCode === 'CERTIFICATIONBONUS') {
                                            handleSubmit(e);
                                        ...
                                        >
                                            ...
                                            <div>
                                                <label className="block text-sm text-[#272727] mb-2 font-medium">
                                                    Partner ID (4-10 characters) {!formData.hearAboutUs && formData.couponCode !== 'CERTIFICATIONBONUS' && <span className="text-red-500">*</span>}
                                                </label>
                                                <div className="relative">
                                                    <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#666666]" />
                                                    <Input
                                                        required={!formData.hearAboutUs && formData.couponCode !== 'CERTIFICATIONBONUS'}
                                                        type="text"
                                            ...
                                            <div className="mt-4 hidden">
                                                ...
                                                {formData.couponCode === 'CERTIFICATIONBONUS' && (
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        {registrationFee.isFree ? (
                                                            <div className="py-2">
                                                                ...
                                                                <div className="text-slate-500 text-sm italic">"CERTIFICATIONBONUS"</div>
                                    ...
                                    <div className="pt-6 flex flex-col sm:flex-row gap-4">
                                        ...
                                        >
                                            {isLoading ? "Processing..." : 
                                             step === 1 ? "Next Step" : 
                                             (step === 2 && formData.couponCode === 'CERTIFICATIONBONUS') ? "Complete Registration" :
                                             step === 2 ? "Next Step" : 
